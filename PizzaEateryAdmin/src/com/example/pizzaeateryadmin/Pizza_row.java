...
public class Pizza_row extends BaseAdapter{
    ...
    public Pizza_row(ArrayList<Integer> id,ArrayList<String> name,ArrayList<String> price,ArrayList<String> img, Activity cont)
    {
    	this.id=id;
    	this.name=name;
    	this.price=price;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null)
		{
			...
			convertView=inf.inflate(R.layout.pizza_list_rw, null);
		...
		holder.b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {		
					...
					jobj2.put("pz",jobj);
					int rs;
					JSONObject jobj3=hj.execJson("UpdateStdPizza",jobj2);
				    rs=jobj3.getInt("UpdateStdPizzaResult");
				    if(rs==1){
		...
		holder.b2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					jobj.putOpt("pizza_id",id.get(position));
					int rs;
					JSONObject jobj3=hj.execJson("DeletePizza",jobj);
				    rs=jobj3.getInt("DeletePizzaResult");
				    if(rs==1){
				    Intent i = new Intent(context, StndPizzaList.class);
